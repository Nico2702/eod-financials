...
def _get_github_user(token: str) -> dict | None:
...
def require_login():
    """
    Call at the very top of eodhd_fundamentals.py.
...
def _render_user_badge():
    """Small badge in the top-right showing logged-in user with logout button."""
    user = current_user()
